...
const RevenueCard = ({ primary, secondary, content, iconPrimary, color, onClick, width_m }: any) => {
    ...
    return (
        <Card sx={{ background: color, position: 'relative', color: '#fff', width: width_m }}>
            {' '}
            <Button style={{ width: '100%', color: '#fff' }} onClick={onClick}>
                <CardContent>
                    <Typography
                        variant="body2"
                        sx={{
